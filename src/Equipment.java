...
public class Equipment
{
    ...
    public boolean equals(Object other)
    {
        ...
        return Objects.equals(name, otherEq.name) && Objects.equals(count, otherEq.count) && Double.compare(otherEq.totalWeight, totalWeight) == 0 &&
        		Double.compare(otherEq.totalPrice, totalPrice) == 0 && Objects.equals(description, otherEq.description);
        // TODO: finish method
    }
}
